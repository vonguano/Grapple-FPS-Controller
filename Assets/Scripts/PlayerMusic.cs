...
namespace ElmanGameDevTools.PlayerAudio
{
    ...
    public class PlayerMusic : MonoBehaviour
    {
        ...
        [Header("References")]
        // Fully-qualified type to avoid ambiguity during compilation
        public ElmanGameDevTools.PlayerSystem.PlayerController playerController;
        ...
        private void FindPlayerController()
        {
            ...
            {
                playerController = GetComponent<ElmanGameDevTools.PlayerSystem.PlayerController>();
        ...
        private void UpdateMovementState()
        {
            ...
            bool wantsToRun = Keyboard.current.shiftKey.isPressed && Keyboard.current.wKey.isPressed && !isActuallyCrouching;
